...
public final class BiblioWS_BiblioWSSOAP_Client {
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        {
        System.out.println("Invoking listeAlerteRetour...");
        java.lang.String _listeAlerteRetour_parameters = "";
        fr.yogj.bibliows.ListeAlerteRetourResponse _listeAlerteRetour__return = port.listeAlerteRetour(_listeAlerteRetour_parameters);
        System.out.println("listeAlerteRetour.result=" + _listeAlerteRetour__return);


        }
        {
        System.out.println("Invoking listeRappelRetour...");
        java.lang.String _listeRappelRetour_parameters = "";
        fr.yogj.bibliows.ListeRappelRetourResponse _listeRappelRetour__return = port.listeRappelRetour(_listeRappelRetour_parameters);
        System.out.println("listeRappelRetour.result=" + _listeRappelRetour__return);
        ...
        {
        System.out.println("Invoking obtenirReservationUtilisateur...");
        int _obtenirReservationUtilisateur_idUtilisateur = 0;
        try {
            java.util.List<fr.yogj.bibliows.types.ReservationType> _obtenirReservationUtilisateur__return = port.obtenirReservationUtilisateur(_obtenirReservationUtilisateur_idUtilisateur);
            System.out.println("obtenirReservationUtilisateur.result=" + _obtenirReservationUtilisateur__return);

        } catch (ObtenirReservationUtilisateurFault_Exception e) {
            System.out.println("Expected exception: ObtenirReservationUtilisateurFault has occurred.");
            System.out.println(e.toString());
        }
            }
        {
        System.out.println("Invoking reserverOuvrage...");
        int _reserverOuvrage_idLivre = 0;
        int _reserverOuvrage_idUtilisateur = 0;
        try {
            fr.yogj.bibliows.types.ReservationType _reserverOuvrage__return = port.reserverOuvrage(_reserverOuvrage_idLivre, _reserverOuvrage_idUtilisateur);
            System.out.println("reserverOuvrage.result=" + _reserverOuvrage__return);

        } catch (ReserverOuvrageFault_Exception e) {
            System.out.println("Expected exception: reserverOuvrageFault has occurred.");
            System.out.println(e.toString());
        }
            }
        {
        ...
        {
        System.out.println("Invoking annulerReservation...");
        int _annulerReservation_idReservation = 0;
        try {
            fr.yogj.bibliows.types.LivreType _annulerReservation__return = port.annulerReservation(_annulerReservation_idReservation);
            System.out.println("annulerReservation.result=" + _annulerReservation__return);

        } catch (AnnulerReservationFault_Exception e) {
            System.out.println("Expected exception: annulerReservationFault has occurred.");
            System.out.println(e.toString());
        }
            }
        {
        System.out.println("Invoking modifRappelOption...");
        fr.yogj.bibliows.ModifRappelOption _modifRappelOption_parameters = null;
        java.lang.String _modifRappelOption__return = port.modifRappelOption(_modifRappelOption_parameters);
        System.out.println("modifRappelOption.result=" + _modifRappelOption__return);
        ...
        {
        System.out.println("Invoking obtenirEmpruntLivre...");
        int _obtenirEmpruntLivre_idLivre = 0;
        try {
            java.util.List<fr.yogj.bibliows.types.LivreEmpruntType> _obtenirEmpruntLivre__return = port.obtenirEmpruntLivre(_obtenirEmpruntLivre_idLivre);
            System.out.println("obtenirEmpruntLivre.result=" + _obtenirEmpruntLivre__return);

        } catch (ObtenirEmpruntLivreFault e) {
            System.out.println("Expected exception: ObtenirEmpruntLivreFault has occurred.");
            System.out.println(e.toString());
        }
            }
        {
        System.out.println("Invoking obtenirReservationOuvrage...");
        int _obtenirReservationOuvrage_idLivre = 0;
        java.util.List<fr.yogj.bibliows.types.ReservationType> _obtenirReservationOuvrage__return = port.obtenirReservationOuvrage(_obtenirReservationOuvrage_idLivre);
        System.out.println("obtenirReservationOuvrage.result=" + _obtenirReservationOuvrage__return);
